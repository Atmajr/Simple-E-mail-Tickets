...
<head runat="server">
    <title>Tech Company Online Support System</title>
...
<body>
    ...
    <div class="form">
        <h1>Tech Company Support Ticket System</h1>
...
&nbsp;
        ...
        <br />
        <br />
        <asp:Label ID="Label7" runat="server" CssClass="label" Text="Please explain your issue using the box below"></asp:Label>
        ...
        <br />
        <asp:TextBox ID="textboxIssue" runat="server" Height="327px" Rows="100" TextMode="MultiLine" ToolTip="Describe the nature of the problem in detail" Width="494px" style="resize:none;"></asp:TextBox>
        <br />
        <br />
